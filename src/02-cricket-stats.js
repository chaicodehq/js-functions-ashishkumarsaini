...
export const calcEconomy = (runsConceded, overs) => overs > 0 && runsConceded >= 0 ? parseFloat((runsConceded / overs).toFixed(2)) : 0;
...
export const isAllRounder = (battingAvg, economy) => Boolean(battingAvg > 30 && economy < 8);
